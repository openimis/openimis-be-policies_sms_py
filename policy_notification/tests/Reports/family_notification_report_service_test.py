...
class TestFamilyNotificationReportServices(TestCase):
    ...
    def test_report_builder(self):
        ...
        self.assertEqual(bool(family_list['family_notification_approval']), self.test_family.family_sms.approval_of_notification)
        self.assertEqual(family_list['family_notification_language'], self.test_family.family_sms.language_of_notification)
