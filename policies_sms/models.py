...
class FamilySMS(core_models.BaseVersionedModel):
    ...
    approval_of_sms = models.BooleanField(db_column='ApprovalOfSMS', default=False, null=False)
    language_of_sms = models.CharField(db_column='LanguageOfSMS', max_length=5,
